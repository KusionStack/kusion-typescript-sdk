...
export class BackendService {
     ...
     * List all backends
     */
    public static listBackend<ThrowOnError extends boolean = false>(options?: OptionsLegacyParser<unknown, ThrowOnError>) {
...
export class OrganizationService {
     ...
     */
    public static listOrganization<ThrowOnError extends boolean = false>(options?: OptionsLegacyParser<unknown, ThrowOnError>) {
...
export class ResourceService {
     ...
     */
    public static listResource<ThrowOnError extends boolean = false>(options?: OptionsLegacyParser<unknown, ThrowOnError>) {
...
export class WorkspaceService {
     ...
     * List all workspaces
     */
    public static listWorkspace<ThrowOnError extends boolean = false>(options?: OptionsLegacyParser<unknown, ThrowOnError>) {
